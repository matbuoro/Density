...
for (i in 1:dataToJags$n){
  ...
  dens[i]<-N_inits[i]/(dataToJags$area[i]/100)
}
...
save(jagsfit,file="results/jagsfit_BH.Rdata")
...
pdf(file="results/Observed_densityByPop_BH.pdf")
par(mfrow=c(2,1))
